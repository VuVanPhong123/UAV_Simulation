...
def find_cache_dir(map_id="hanoi_default", base_dir=None):
    maps_dir = Path(base_dir) if base_dir is not None else default_maps_dir()
    return maps_dir / map_id


def cache_exists(map_id="hanoi_default", base_dir=None):
...
def load_map_cache(map_id="hanoi_default", base_dir=None):
    cache_dir = find_cache_dir(map_id, base_dir)
