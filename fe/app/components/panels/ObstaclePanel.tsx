        ...
        <section className="rounded border border-slate-200 bg-white p-3">
            ...
            <div className="mt-3 space-y-3">
                <label className="block cursor-pointer text-xs font-semibold text-slate-600">
                    ...
                    <input className="mt-1 w-full cursor-pointer" type="range" min="2" max="30" value={obstacleConfig.radius} onChange={e => onChange('radius', Number(e.target.value))} />
                </label>
                <label className="block cursor-pointer text-xs font-semibold text-slate-600">
                    Độ cao: {obstacleConfig.height}m
                    <input className="mt-1 w-full cursor-pointer" type="range" min="5" max="120" value={obstacleConfig.height} onChange={e => onChange('height', Number(e.target.value))} />
                </label>
                <label className="block cursor-pointer text-xs font-semibold text-slate-600">
                    Loại vật cản
                    <select
                        ...
                        className="mt-1 w-full cursor-pointer rounded border border-slate-300 bg-white px-2 py-2 text-xs font-semibold text-slate-700"
                    >
                ...
                {isPlacingObstacle ? (
                    ...
                    <button
                        ...
                        className="w-full cursor-pointer rounded bg-orange-600 px-3 py-2 text-xs font-bold text-white hover:bg-orange-700"
                    >
                        Tạo vật cản
                    </button>
                )}
